package com.timerdemo.morphing;
...
public class MorphingView extends View {
	...
	public MorphingView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Configure view with AttributeSet
		init();
	}

	public MorphingView(Context context, AttributeSet attrs, int defStyle) {
