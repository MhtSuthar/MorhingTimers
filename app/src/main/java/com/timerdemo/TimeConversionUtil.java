...
public class TimeConversionUtil {
	...
	public static String STOP_WATCH_TIME="stop_time";
	...
	public static String getTimeStringFromMilliseconds1(long milliseconds) {
		String seconds = Integer
				.toString(getSecondsFromMilliseconds(milliseconds));
		String minutes = Integer
				.toString(getMinutesFromMilliseconds(milliseconds));
		String hours = Integer.toString(getHoursFromMilliseconds(milliseconds));
		int mill=(int) (milliseconds % 1000);
		for (int i = 0; i < 2; i++) {
			if (seconds.length() < 2) {
				seconds = "0" + seconds;
			}
		...
		return hours + ":" + minutes + ":" + seconds + "," +String.valueOf(mill).charAt(0);
	}
	...
	public static String getTimeMillSec(long millisUntilFinished) {
		int mill=(int) (millisUntilFinished % 1000);
		if(String.valueOf(mill).length() >= 2){
			return String.valueOf(String.valueOf(mill).charAt(0) + "" + String.valueOf(mill).charAt(1));
		}else{
			return String.valueOf(String.valueOf(mill).charAt(0));
		}
	}
}
